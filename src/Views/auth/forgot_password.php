...
<title>STAFF — Mot de passe oublié</title>
<style>
...
input[type=email]{width:100%;background:#0a0e1a;border:1px solid #1e2d45;border-radius:8px;padding:11px 14px;color:#e2e8f0;font-family:'DM Sans',sans-serif;font-size:0.9rem;outline:none;transition:border-color 0.2s;margin-bottom:18px;}
...
<div class="card">
  ...
  <div class="subtitle">Réinitialiser votre mot de passe</div>

  <?php if (!empty($msg)):   ?><div class="msg-ok"><?= htmlspecialchars($msg) ?></div><?php endif; ?>
